...
const api = {
    ...
    renderSidebar: () => {
        ...
        // NARROW PROFESSIONAL WIDTH
        sb.style.cssText = "width:220px; height:100vh; background:#2c3e50; color:white; position:fixed; display:flex; flex-direction:column; overflow:hidden;";
        ...
        if (isStd) {
            menuHtml = `<div style="padding:15px; background:#34495e;"><a href="admin_dashboard.html" style="color:#3498db; text-decoration:none; font-weight:bold; font-size:0.8rem;">⬅ BACK HOME</a></div>
            <div style="padding:15px;"><p style="color:#3498db; font-size:0.65rem; font-weight:bold; text-transform:uppercase; margin-bottom:10px;">Students</p>
            ...
            menuHtml = `<div style="padding:15px; background:#34495e;"><a href="admin_dashboard.html" style="color:#3498db; text-decoration:none; font-weight:bold; font-size:0.8rem;">⬅ BACK HOME</a></div>
            <div style="padding:15px;"><p style="color:#3498db; font-size:0.65rem; font-weight:bold; text-transform:uppercase; margin-bottom:10px;">Staff & HR</p>
            <ul style="list-style:none; padding:0; font-size:0.85rem; line-height:2;">
                <li><a href="staff_registration.html" style="color:white; text-decoration:none;">➕ Hire Staff</a></li>
                <li><a href="staff_directory.html" style="color:white; text-decoration:none;">📂 Staff List</a></li>
                <li><a href="payroll.html" style="color:white; text-decoration:none;">💰 Payroll</a></li>
            </ul></div>`;
        } else if (isFin) {
            menuHtml = `<div style="padding:15px; background:#34495e;"><a href="admin_dashboard.html" style="color:#3498db; text-decoration:none; font-weight:bold; font-size:0.8rem;">⬅ BACK HOME</a></div>
            <div style="padding:15px;"><p style="color:#27ae60; font-size:0.65rem; font-weight:bold; text-transform:uppercase; margin-bottom:10px;">Finance</p>
            <ul style="list-style:none; padding:0; font-size:0.85rem; line-height:2;">
            ...
            menuHtml = `<div style="padding:15px; background:#34495e;"><a href="admin_dashboard.html" style="color:#3498db; text-decoration:none; font-weight:bold; font-size:0.8rem;">⬅ BACK HOME</a></div>
            <div style="padding:15px;"><p style="color:#f1c40f; font-size:0.65rem; font-weight:bold; text-transform:uppercase; margin-bottom:10px;">Academics</p>
            <ul style="list-style:none; padding:0; font-size:0.85rem; line-height:2;">
            ...
            menuHtml = `<div style="padding:20px; border-bottom:1px solid rgba(255,255,255,0.1); text-align:center;"><h2 style="color:#3498db; margin:0; font-size:1rem;">Livingstone</h2></div>
        ...
        sb.innerHTML = `
            <div style="display:flex; flex-direction:column; height:100%; border-right:1px solid rgba(0,0,0,0.1); background:#2c3e50; color:white;">
                ${menuHtml}
                <div style="margin-top:auto; padding:12px; background:#c0392b; cursor:pointer; text-align:center; font-weight:bold; color:white; font-size:0.85rem;" onclick="api.logout()">Logout 🚪</div>
            </div>
        `;
    }
};
