        ...
        if (isFin) {
            menuHtml = `
                ...
                <div style="padding:15px; overflow-y:auto; flex-grow:1;">
                    ...
                    <ul style="list-style:none; padding:0; font-size:0.85rem; color:#bdc3c7; margin-bottom:20px;">
                        <li style="margin-bottom:8px;"><a href="fee_structure.html" style="color:white; text-decoration:none;">✅ Setup Fees</a></li>
                        <li><a href="fee_summary.html" style="color:white; text-decoration:none;">✅ Summary</a></li>
                    </ul>
                    <p style="color:#27ae60; font-size:0.7rem; font-weight:bold; text-transform:uppercase; margin-bottom:10px;">💰 Payments</p>
                    <ul style="list-style:none; padding:0; font-size:0.85rem; color:#bdc3c7; margin-bottom:20px;">
                        <li style="margin-bottom:8px;"><a href="record_payment.html" style="color:white; text-decoration:none;">✅ New Payment</a></li>
                        <li><a href="financial_reports.html" style="color:white; text-decoration:none;">📈 Logs</a></li>
                    </ul>
            ...
            menuHtml = `
                <div style="padding: 20px; border-bottom: 1px solid rgba(255,255,255,0.1); text-align:center;">
                    <h2 style="color:#3498db; margin:0; font-size: 1rem;">Livingstone</h2>
                </div>
